...
- **Semantic colours:** amber `#D98A00` (acme), violet `#6D4AE0` (globex, Asha), green `#137A50` (initech, Ben, Verified), red `#C2410C` (errors, Locked). Text on or in these colours must meet 4.5:1; use darker text tones where needed.
