...
export const SITE_DESCRIPTION =
  'Backend engineer building Spring Boot REST APIs, scheduling workflows, OTP and JWT auth, and schema-per-tenant SaaS on SQL Server, PostgreSQL and Azure.';
