...
**Assets.** Icons are Next.js metadata files under `app/`: `icon.svg`, `apple-icon.png`, `favicon.ico`. The Open Graph image is `public/og-image.png` (1200x630), referenced from `app/layout.tsx`. The resume PDF is in `public/`.
